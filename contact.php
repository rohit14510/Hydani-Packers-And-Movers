...
$mail->Port     = 587;
// Sender info 
$mail->setFrom('info@thepiyushpackers.in', 'Hi Dhani Packers And Movers'); 
$mail->addReplyTo('info@thepiyushpackers.in', 'Test Email'); 
 
// Add a recipient 
$mail->addAddress('thepiyushpackers@gmail.com'); 
...
$mailContent = ' 
    ...
    <p>Hi Dhani Packers And Movers</p>';  
...
if(!$mail->send()){ ?>
    ...
    window.location.href="http://thepiyushpackers.in/index.html";
    </script>
    // 
    <?php
